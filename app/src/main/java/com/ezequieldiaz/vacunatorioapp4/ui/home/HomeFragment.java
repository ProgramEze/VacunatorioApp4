...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        viewModel.irAFragment(null); // <- limpia cualquier navegación anterior
        ...
        binding.btnTurno.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                viewModel.irAFragment(new HomeFragmentViewModel.Navegacion(R.id.nav_turno, null));
            }
        });
        ...
        viewModel.getNavegacion().observe(getViewLifecycleOwner(), new Observer<HomeFragmentViewModel.Navegacion>() {
            ...
            public void onChanged(HomeFragmentViewModel.Navegacion navegacion) {
                if (navegacion != null) {
                    ...
                    // 🔻 Removemos el observer después de usarlo
                    viewModel.irAFragment(null); // limpia el valor
                }
            }
        });
